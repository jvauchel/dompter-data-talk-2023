...
== Merci à tous les sponsors et à SnowCamp !

image:images/sponsors.png[width = 800]
...
image::images/snowboard.gif[width=400]
...
image:images/SnowCampQrcode.png[width=300]
