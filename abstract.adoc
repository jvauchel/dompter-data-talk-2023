...
//
// Dans ce retour d'expérience, je vais d’abord partager avec vous mon parcours à travers les maths, la 3D et la Data. Je vous parlerai des moyens utilisés pour me former à la Data, et la place essentielle de la cohésion d’équipe dans ma reconversion.
//
